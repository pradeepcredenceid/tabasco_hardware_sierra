 ...
 * fcp_to_ts_51011
 *
 * Parses the TLVs of a File Control Parameters list received from a 
 * 3G USIM and packs the results into a 2G format as defined in 
 * ETSI TS 51011 which is the format the java framework is expecting
 */
