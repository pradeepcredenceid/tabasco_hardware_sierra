/* -------------------------------------------------------------------------
 ...
 Revision Information:
    $File name:  /msw_tools/FlashTool/libFlsTool/src/sha1.cpp $
    $CC-Version: .../dhkristx_140314_v0/2 $
    $Date:       2014-04-23    11:04:14 UTC $
 ----------------------------------------------------------------------
 by CCCT (0.12l)
 ---------------------------------------------------------------------- */
 ...
 *
 *****************************************************************************
 *	$Id: sha1.cpp,v 1.7 2002/06/02 20:04:28 paulej Exp $
 *****************************************************************************
 *
 *	Description:
...
void SHA1::ScatterInput(	const unsigned char	*message_array,
					unsigned 			length,
               unsigned       ScatterDistance)
{
	...
	{
		Message_Block[Message_Block_Index++] = (unsigned char)(*message_array & 0xFF);
