/*************
 *
 * $Id: sluproto.h,v 1.10 2009/02/11 19:47:48 blee Exp $
 *
 * Filename - sluproto.h - User (external) function prototypes
 *
...
extern size_t slstrlenutf8(const char * _s)
;
#endif
