/*************
 *    
 * $Id: slucs2.c,v 1.4 2009/02/11 19:49:13 blee Exp $
 *
 * Filename: slucs2.c 
 *
 ...
 *
 **************/
global size_t slstrlenutf8(const char * sp)
{
    ...
    for (lsp = sp; (uintptr_t)(lsp) & (sizeof(size_t) - 1); lsp++) {
        b = *lsp;
