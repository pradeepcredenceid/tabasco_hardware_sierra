/*************
 *
 * $Id: hdidefs.h,v 1.6 2008/10/28 21:28:54 blee Exp $
 *
 * Filename: hdidefs
 *
...
#define HDRXBUFSIZE   HPMAXMESSAGE  /* Size of each block in the pool */
 ...
 *************/
struct hdSendblk {
    swi_uint8 hddata[2*HPMAXMESSAGE];
};
 ...
 *          hdOutoffset      - Offset into hdRxPool blk to place HIP header
