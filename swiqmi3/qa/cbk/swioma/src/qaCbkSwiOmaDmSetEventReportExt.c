 ...
 * \ingroup cbk
 *
 * \file qaSwiOmsDmSetEventReportExt.c
 *
 ...
 *
 */
package enum eQCWWANError PkQmiCbkSwiOmaDmSetEventReportExt(
    WORD *pMlength,
    BYTE *pParamField )
{
 ...
 *
 */
package enum eQCWWANError UpkQmiCbkSwiOmaDmSetEventReportExt(
    BYTE                                    *pMdmResp,
